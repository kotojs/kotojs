define(['exports', 'module', 'd3', './assert.js', './layer.js'], function (exports, module, _d3, _assertJs, _layerJs) {
  'use strict';
  ...
  var _Layer = _interopRequireDefault(_layerJs);

  // d3 is required
  (0, _kotoAssert['default'])(_d32['default'], 'd3 js is required.');
    ...
    _createClass(Chart, [{
      ...
      value: function layer(name, selection, options) {
        ...
        if (arguments.length === 2) {
          ...
          if (selection instanceof _Layer['default']) {
            selection._chart = this;
            this._layers.set(name, selection);
            return this._layers.get(name);
          } else {
            (0, _kotoAssert['default'])(false, 'When reattaching a layer, the second argument must be a koto layer');
          }
        }

        selection._chart = this;

        _layer = new _Layer['default'](selection, options);
      ...
      value: function config(nameOrObject, value) {
        ...
        if (arguments.length === 1) {
          ...
          (0, _kotoAssert['default'])(this.configs.has(nameOrObject), nameOrObject + ' is not a valid option.');
      ...
      value: function accessor(item, value) {
        ...
        if (arguments.length === 1) {
          if (typeof item === 'string') {
            (0, _kotoAssert['default'])(this.accessors.has(item), item + ' is not a valid accessor.');
